...
public class ServletControle extends HttpServlet {
	...
	protected void orcamento(HttpServletRequest request, HttpServletResponse response)
		...
		//endereco
		Endereco e = new Endereco(null, request.getParameter("endereco"), request.getParameter("num"), request.getParameter("bairro"),request.getParameter("cidade"));
		...
		try {
			...
			request.setAttribute("message", "<div class='alert alert-success text-center' id='div'><button type='button' class='close' data-dismiss='alert'>×</button><span class='glyphicon glyphicon-thumbs-up' style='font-size:20px;'></span> Seu Orçamento foi enviado com sucesso, Aguarde a Resposta</div>");
