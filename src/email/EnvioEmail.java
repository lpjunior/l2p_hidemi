...
public class EnvioEmail {
	...
	public static Session login() {
		Session session = Session.getDefaultInstance(abrirConex(), new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				return new PasswordAuthentication("aula.sendmail@gmail.com", "123qwe..");//email e senha do usuario
			}
	...
	public void htmlMail(String logo, String email, String sub, String nome, String clienteEmail, String clienteTelefone,
			String clienteMenssagem) {
		...
		try {
			...
			html.append(
					"              <div align=\"center\" style='background-color:rgba(0,0,0,.75); height:60px;'>\r\n"
							+ "                    \r\n"
							+ "                    <p style=\"\"><a style=\"color: white;text-decoration: none;\" href=\"https://www.hidemiphone.com.br\" target=\"_blank\" title=\"HidemiPhone\">© 2017 Todos direitos reservados </a>| Designed by Turma 2016.3</p>\r\n"
							+ "                </div> ");
			html.append("</div>");
		
			String cod = ""+html;
			messageBodyPart.setContent(cod, "text/html");

			multipart.addBodyPart(messageBodyPart);

			messageBodyPart = new MimeBodyPart();
			DataSource fds = new FileDataSource(
					logo+"\\logo-branco.jpg");
	...
	public static void orcamento(String logo,String email,String sub, Orcamento o,String frente,String lateral,String verso) {
