        ...
        <section class="login_content">
          ...
          <form action="Login" name="formlogin" id="login" method="post">
            ...
            <div class="separator">
              ...
              <div>
                <h1 style="margin-bottom: 10px;"><i class="fa fa-apple fa-2x" aria-hidden="true" style="color: red;"></i> Hid<b style="font-size: 72%;">EM</b><b style="color: red;">i</b>Phone</h1>
                <p><a href="https://www.hidemiphone.com.br" target="_blank" title="hidemiphone">&copy;2017 Todos direitos reservados </a><br>| <br>Designed by Turma 2016.3</p>
              </div>
              <hr>
              ${msg }
            </div>
          ...
          <div class="conteudo">
            ...
            <div>
              <p>Não lembrou da senha, clique aqui!
                <a href="#" class="to_register"> Solicitar senha </a>
              </p>
            </div>
...
$(function() {
	$("#esquecisenha").on('click', function(){
		...
		if (email.length == 0) {
			...
			$.post('EsqueciSenha',{email : email},
					function(resultado){
				$("#resp").html('<div class="alert alert-info">'+resultado+"</div>");
				$("#esquecisenha").show();
			});
		}
		return false;
