      ...
      <div class="row">
        ...
        <small id="fileHelp" class="form-text text-muted">
                ...
                <div class="form-group">
                  ...
                  <textarea name="descricao" class="form-control" rows="4" maxlength="500" style="resize: none;" value="" placeholder="Descrição do produto..."></textarea>
                </div>
                <div class="form-group">
                  <label for="title" class="form-control-label">Preço</label>
                  <input type="text" name="preco" class="form-control" value="" placeholder="Preço do produto...">
                </div>
                <div class="form-group">
