              ...
              <form>
                 <div class="form-group">
                          <div class="main-img-preview">
                            <img class="thumbnail img-mostrar-1" src="http://dummyimage.com/800x600/4d494d/686a82.jpg&text=Imagem+Aparelho" title="Imagem do Serviço">
                        </div>
                        <hr>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nome" class="form-control" value="" placeholder="Nome do aparelho...">
                </div>
               <div class="form-group">
                <div class="row">
                <div class="col-md-9">
                  <label for="title" class="form-control-label">Descrição</label>
                  <input type="text" name="descricaoServ" class="form-control" value="" placeholder="Tipo de serviço...">
                </div>
                <div class="col-md-3">
                  <label for="title" class="form-control-label">Preço </label>
                  <input type="text" name="precoServ" class="form-control" value="" placeholder="Valor do serviço...">
                  </div>
                  </div>
                  <hr>
